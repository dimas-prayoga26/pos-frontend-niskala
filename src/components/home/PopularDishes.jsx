  ...
  return (
    <div className="mt-6 xl:pr-6">
      <div className="bg-[#1a1a1a] w-full rounded-lg">
        ...
        <div className="overflow-y-auto max-h-[520px] xl:h-[680px] scrollbar-hide pb-4">
          {popularDishes.map((dish) => {
            return (
              <div
                key={dish.id}
                className="flex items-center gap-4 bg-[#1f1f1f] rounded-[15px] px-4 md:px-6 py-4 mt-4 mx-4 md:mx-6"
              >
